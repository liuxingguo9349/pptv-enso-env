...
shape2 = ['alltransgrad','singlemodel','bm1mon12gradmean.gdat','lead1mon12']             #singlemodel    samelead
tmp = shape2
#name = tmp[3]
...
for l in range(10):
    ...
    for t in range(12):
        ...
        ipth2 = 'E:/hyyc/pytorchCNN/PTPV/'+tmp[1]+'/springseparate/'       #保存结果文件夹
    ...
    spring = allgrad[3:8]
    # spring = np.zeros((7,6,24,72))
    # spring[0:3] = allgrad[0:3]
    # spring[3:] = allgrad[8:]
    ...
    space = '                                              '
    plt.title('Lead '+str(l+1)+' month '+ 'spring forecast'+' P.T.P.V'+ space + '[El Niño Heatmap]', fontsize=8, y=0.962, x=0.5)
